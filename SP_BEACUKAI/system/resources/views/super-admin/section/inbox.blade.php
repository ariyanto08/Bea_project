...
<link rel="stylesheet" href="{{ url('public') }}/assets-super-admin/vendor/sweetalert/sweetalert.css"/>

<!-- MAIN CSS -->
<link rel="stylesheet" href="{{ url('public') }}/assets-super-admin/css/main.css">
<link rel="stylesheet" href="{{ url('public') }}/assets-super-admin/css/inbox.css">
</head>
                            ...
                            <div class="mail-right">
                                ...
                                <div class="mail-detail-full" id="mail-detail-open" style="display: none;">
                                    ...
                                    <div class="detail-header">
                                        <div class="media">
                                            <div class="float-left">
                                                <div class="mr-3"><img src="{{ url('public') }}/assets-super-admin/images/sm/avatar1.jpg" alt=""></div>
                                            </div>
...
<script src="{{ url('public') }}/assets-super-admin/vendor/sweetalert/sweetalert.min.js"></script> <!-- SweetAlert Plugin Js -->

<!-- page js file -->
<script src="{{ url('public') }}/assets-super-admin/bundles/mainscripts.bundle.js"></script>
<script src="{{ url('public') }}/assets-super-admin//js/pages/ui/dialogs.js"></script>
<script>
